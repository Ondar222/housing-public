    ...
    return (
        <div className="Container_CatalogProgramsPage" >
            <div className="Block_CP_Page">
                <h2 className="Title_CP_Page">Каталог программ с государственной поддержкой</h2>
                <h4 className="Second_Title_CP_Page">Краткое описание всех жилищных программ мэрии города Кызыл</h4>
            </div>
