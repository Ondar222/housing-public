        ...
        <div className="housiung_programs_container" style={{  background: "white" }}>
            <div className="housiung_programs_info_block">
                <div className="programs_info_block_title_block">
                    ...
                    <Flex className="programs_flex_application" gap="small" wrap="wrap">
                        <Button className="programs_button_application" href="/programs"  type="primary" icon={<CheckOutlined />}>
                            Подать заявку
                        </Button>
                        <Button className="programs_button_queue_application" href="/queue">Моя очередь</Button>
                    </Flex>
